...
std::optional<LogarithmicValueMapper::Params> LogarithmicValueMapper::parseParams(const utils::OptionParser::OptionMap& optionMap, utils::Rainmeter::ContextLogger& cl) {
	Params params;
