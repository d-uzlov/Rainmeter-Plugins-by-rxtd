...
#pragma once
#include "butterworth_lib/ButterworthWrapper.h"
#include "filter_utils/InfiniteResponseFilter.h"
#include "rxtd/GrowingVector.h"

namespace rxtd::audio_utils {
	class DownsampleHelper {
		using ButterworthWrapper = audio_analyzer::audio_utils::butterworth_lib::ButterworthWrapper;
		template<index order>
		using InfiniteResponseFilterFixed = audio_analyzer::audio_utils::filter_utils::InfiniteResponseFilterFixed<order>;
