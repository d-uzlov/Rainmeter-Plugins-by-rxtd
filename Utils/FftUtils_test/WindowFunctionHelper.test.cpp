...
namespace rxtd::test::fft_utils {
	...
	public:
		TEST_METHOD(TestCosineSumWindow_100_05_Hann) {
			...
			helper.parse(L"hann", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);
		}

		TEST_METHOD(TestCosineSumWindow_100_05_Hamming) {
			static const float predefined[] = {
			...
			helper.parse(L"hamming", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);
		}

		TEST_METHOD(TestKaiserWindow_100_2) {
			static const float predefined[] = {
			...
			helper.parse(L"kaiser[2]", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);
		}

		TEST_METHOD(TestKaiserWindow_100_3) {
			static const float predefined[] = {
			...
			helper.parse(L"kaiser", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);

			helper.parse(L"kaiser[3]", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);
		}

		TEST_METHOD(TestExponentialWindow_100_869) {
			static const float predefined[] = {
			...
			helper.parse(L"exponential[8.69]", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);

			helper.parse(L"exponential", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);
		}

		TEST_METHOD(TestChebyshevWindow_101_80) {
			static const float predefined[] = {
				...
				0.0588301f, 0.0489372f, 0.040293f, 0.0328049f, 0.026378f, 0.0209169f, 0.0163264f, 0.0125136f, 0.00938819f, 0.00686419f, 0.00486025f, 0.00330047f, 0.00338714f
			};

			WindowFunctionHelper helper;
			std::vector<float> generated;
			generated.resize(101);

			helper.parse(L"chebyshev[80]", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);

			helper.parse(L"chebyshev", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);
		}

		TEST_METHOD(TestChebyshevWindow_151_100) {
			static const float predefined[] = {
				...
				0.00491941f, 0.00389851f, 0.0030493f, 0.0023497f, 0.00177953f, 0.0013204f, 0.000955706f, 0.000670552f, 0.000451686f, 0.000456762f
			};

			WindowFunctionHelper helper;
			std::vector<float> generated;
			generated.resize(151);

			helper.parse(L"chebyshev[100]", option_parsing::OptionParser::getDefault(), Logger{})(generated);
			assertArraysEqual(predefined, generated);
		}
