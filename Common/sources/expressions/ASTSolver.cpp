...
ast_nodes::IndexType ASTSolver::copySubTree(ast_nodes::IndexType oldNodeIndex, array_span<GenericNode> oldNodes, ValueProvider& valueProvider) {
	return oldNodes[oldNodeIndex].visit(
		[&](auto&) -> ast_nodes::IndexType {
